...
function agent_Change(value){
    if(value == "Killjoy"){
        document.getElementById("agent_BioText").classList.remove('animation')
        ...
        document.getElementById("agent_Image").className = 'agent_Animation';
        document.getElementById("agent_RoleText").className = 'animation';
        document.getElementById("agent_BioText").className = 'animation';
    }else if(value == "Yoru"){
